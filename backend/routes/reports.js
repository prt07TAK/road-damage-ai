...
// POST - AI auto-report webhook
router.post('/auto-report', async (req, res) => {
  try {
    const { location, damageType, severity, confidence, imageURL, notes } = req.body;
    ...
    const report = new DamageReport({
      ...
      confidence: confidence || 1.0,
      session: null,
      notes: notes || 'Auto-generated by AI backend'
    });
